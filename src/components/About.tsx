...
import { profile, marqueeItems } from "@/data/content";

const pillars = [
  {
    title: "AI stack",
    desc: "Computer Vision, LLM fine-tuning, RAG, multi-agent workflows, 3D reconstruction.",
    icon: "flask",
  },
  {
    title: "Web stack",
    desc: "Next.js, React, Ruby on Rails, Laravel, ERPNext/Frappe — full platforms shipped.",
    icon: "rocket",
  },
  {
    title: "Production mindset",
    desc: "MLOps, CI/CD, Docker, AWS — building resilient services that run at scale.",
    icon: "layers",
  },
];
        ...
        <div className="mt-10 grid gap-12 lg:grid-cols-[1fr_0.9fr] lg:gap-16">
          ...
          <div className="reveal" data-reveal-delay="80">
            <h2 className="font-display text-3xl font-bold leading-tight text-white sm:text-4xl">
              ...
              <span className="text-gradient">AI &amp; full-stack web.</span>
            </h2>
            <div className="mt-6 space-y-4 text-base leading-relaxed text-slate-400">
              <p>{profile.summary}</p>
              <p>
                I thrive across the entire AI lifecycle — collecting and
                annotating data, training and fine-tuning models, and deploying
                them as resilient production services — and across the full web
                stack, from database to UI. My work powers live platforms serving
                real users, where accuracy, latency, and uptime aren&apos;t
                optional.
              </p>
            </div>
          ...
          <div className="reveal space-y-4" data-reveal-delay="160">
            <HighlightCard
              index="01"
              title="7+ years building & shipping"
              desc="Delivered 20+ products, 14 of them live in production, spanning AI and full-stack web platforms."
              accent="from-amber-400/20"
            />
            <HighlightCard
              index="02"
              title="Dual-domain expertise"
              desc="Production Computer Vision, Generative & Agentic AI — plus complete web apps."
              accent="from-brand-400/20"
            />
            <HighlightCard
              index="03"
              title="Production scale"
              desc="500+ concurrent conversations, real-time vision, multi-site monitoring."
              accent="from-accent-400/20"
            />
