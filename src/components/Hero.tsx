    ...
    >
      <div className="container-px">
        <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
          {/* Left: copy */}
          <div>
            <div className="reveal is-visible inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-amber-400/10 px-3 py-1 text-xs font-medium text-amber-300">
            ...
            <h1 className="mt-6 font-display text-5xl font-bold leading-[1.05] tracking-tight text-white sm:text-6xl lg:text-7xl">
              ...
              <span className="mt-1 block">Abdullah</span>
              <span className="text-gradient block">Tariq Abbasi</span>
            </h1>
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-400 sm:text-lg">
              {profile.tagline} I ship real products across two stacks — from
              real-time vision &amp; autonomous agents to full web platforms.
            </p>
            ...
            <div className="mt-8 flex items-center gap-5 text-sm text-slate-500">
              ...
              <a href={profile.linkedin} target="_blank" rel="noreferrer" className="group inline-flex items-center gap-1.5 transition-colors hover:text-slate-200">
                <LinkedinIcon className="h-4 w-4 text-accent-400" />
    ...
    <div className="relative mx-auto max-w-md">
      ...
      <div className="glass-strong overflow-hidden rounded-2xl shadow-2xl shadow-black/50">
        ...
        <div className="flex items-center gap-2 border-b border-white/10 bg-white/[0.03] px-4 py-3">
          ...
          <span className="ml-2 font-mono text-xs text-slate-400">abdullah@ai-stack: ~</span>
        </div>

        {/* Body */}
        <div className="space-y-3 p-5 font-mono text-[13px] leading-relaxed">
          <p>
            <span className="text-brand-400">abdullah@ai</span>
            <span className="text-slate-500">:</span>
            <span className="text-brand-400">~$</span>{" "}
            <span className="text-slate-200">whoami --stack</span>
          </p>
          <p className="text-slate-400">
            <span className="text-brand-300">→</span> Full Stack AI Engineer · 7+ yrs
          </p>

          <div className="mt-3 space-y-1.5">
            {[
              ["ai", "YOLO v11/v26 · LLMs · RAG · Agents"],
              ["agents", "LangChain · LangGraph · Multimodal"],
              ["web", "Next.js · React · Rails · Laravel"],
              ["deploy", "FastAPI · Docker · AWS · CI/CD"],
            ].map(([k, v]) => (
          ...
          <p className="pt-2">
            ...
            <span className="text-slate-500">:</span>
            <span className="text-brand-400">~$</span>{" "}
            <span className="text-slate-200">deploy --prod fortix sprixle ragewar</span>
          </p>
          <p className="text-brand-300">
            ✓ 20+ products live · AI + Web stacks
          </p>
          <p>
            <span className="text-brand-400">abdullah@ai</span>
            <span className="text-slate-500">:</span>
      ...
      {/* Floating badge */}
      <div className="absolute -right-3 -top-3 rotate-3 rounded-xl border border-amber-400/30 bg-ink-900/90 px-3 py-1.5 text-xs font-semibold text-amber-300 shadow-lg backdrop-blur">
        14× prod ships
      </div>
